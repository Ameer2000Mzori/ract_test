...
export default function Contact() {
  const submitHandler = () => {
    ...
    const intouch =
      "we will be in touch soon! thank you for contacting us and having interst in this game";
        ...
        <section className="Contact-2">
          <div className="Contact-txts">
            ...
            <p className="Contact-p">
              thank you for trying to contact us! we will do our best to respond
              to any emails soon
            </p>
          </div>
          <form className="Contact-form">
            ...
            <lebel value="enter your name" id="enter your name">
              Email
            </lebel>
